...
function run_test() {
    ...
    mvn test -pl systemtests -Psystemtests-shared -Djava.net.preferIPv4Stack=true ${EXTRA_TEST_ARGS}
    mvn test -pl systemtests -Psystemtests-isolated -Djava.net.preferIPv4Stack=true ${EXTRA_TEST_ARGS}
}
