package io.enmasse.systemtest.brokered.clients.proton.jms;

import io.enmasse.systemtest.executor.client.proton.jms.JMSClientSender;
...
public class MsgPatternsTest extends io.enmasse.systemtest.brokered.clients.MsgPatternsTest {
    ...
    public void testBasicMessage() throws Exception {
        doBasicMessageTest(new JMSClientSender(), new JMSClientSender());
    }
