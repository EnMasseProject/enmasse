...
public class TopicTest extends TestBaseWithShared implements ITestBaseStandard {
    ...
    void testDurableSubscriptionOnPooledTopic() throws Exception {
        ...
        Destination subscription = Destination.subscription("mysub", "mytopic", DestinationPlan.STANDARD_SMALL_SUBSCRIPTION.plan());
    ...
    void testDurableSubscriptionOnShardedTopic() throws Exception {
        ...
        Destination subscription1 = Destination.subscription("mysub", "mytopic", DestinationPlan.STANDARD_SMALL_SUBSCRIPTION.plan());
        Destination subscription2 = Destination.subscription("anothersub", "mytopic", DestinationPlan.STANDARD_SMALL_SUBSCRIPTION.plan());
