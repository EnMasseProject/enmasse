...
public class AdminResourcesManagerSingle {

    private static AdminResourcesManagerSingle managerInstance = null;
    ...
    private AdminResourcesManagerSingle() {
    ...
    public AdminResourcesManagerSingle getInstance() {
        if (managerInstance == null) {
            managerInstance = new AdminResourcesManagerSingle();
        }
