...
import io.enmasse.controller.api.v1.types.*;
...
public class HttpApiRootService {
    ...
    private static final APIResourceList apiResourceList = new APIResourceList("v1", "APIResourceList", "enmasse.io/v1",
        Arrays.asList(
                new APIResource("addressspaces", "", false, "AddressSpace",
                    Arrays.asList("create", "delete", "deletecollection", "get", "list")),
                new APIResource("addresses", "", false, "Address",
                    Arrays.asList("create", "delete", "deletecollection", "get", "list"))));
