            ...
            "initContainers": [
              {
                ...
                "volumeMounts": [
                  common.volume_mount("keycloak-providers", "${KEYCLOAK_HOME}/providers"),
                  common.volume_mount("keycloak-configuration", "${KEYCLOAK_HOME}/standalone/configuration"),
            ...
            "containers": [
              {
                ...
                "volumeMounts": [
                  ...
                  common.volume_mount("keycloak-configuration", "${KEYCLOAK_HOME}/standalone/configuration"),
                  common.volume_mount("standard-authservice-cert", "/opt/enmasse/cert"),
                  common.volume_mount("keycloak-persistence", "${KEYCLOAK_HOME}/standalone/data")
                ],
