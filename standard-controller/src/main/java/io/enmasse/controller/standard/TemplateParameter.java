...
public interface TemplateParameter {
    ...
    String BROKER_TREAT_REJECT_AS_UNMODIFIED_DELIVERY_FAILED = "BROKER_TREAT_REJECT_AS_UNMODIFIED_DELIVERY_FAILED";
    String BROKER_USE_MODIFIED_FOR_TRANSIENT_DELIVERY_ERRORS = "BROKER_USE_MODIFIED_FOR_TRANSIENT_DELIVERY_ERRORS";
    String BROKER_MIN_LARGE_MESSAGE_SIZE = "BROKER_MIN_LARGE_MESSAGE_SIZE";

    String ENABLE_GLOBAL_DLQ = "ENABLE_GLOBAL_DLQ";
}
