...
public class IoTInfrastructureTest {
    ...
    void testCreateConfig() {
        IoTInfrastructure config = new IoTInfrastructureBuilder()
                .withNewMetadata()
                .withName("config")
                .endMetadata()
                .withNewSpec()
    ...
    public void testParse() throws IOException {
        ...
        final URL url = IoTInfrastructureTest.class.getResource("resources/iot-config.json");
        final IoTInfrastructure value = mapper.readValue(url, IoTInfrastructure.class);
