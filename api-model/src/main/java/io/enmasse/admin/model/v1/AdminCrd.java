...
public class AdminCrd {
    ...
    static {
        ...
        AUTHENTICATION_SERVICE_CRD = CustomResources.createCustomResource(GROUP, VERSION_V1ALPHA1, AuthenticationService.KIND);
    }
    ...
    public static void registerCustomCrds() {
        ...
        KubernetesDeserializer.registerCustomKind(API_VERSION_V1ALPHA1, AuthenticationService.KIND, AuthenticationService.class);
        KubernetesDeserializer.registerCustomKind(API_VERSION_V1ALPHA1, AuthenticationServiceList.KIND, AuthenticationServiceList.class);
