...
ConsoleServer.prototype.listen = function (env, callback) {
    ...
    return new Promise((resolve, reject) => {
        ...
        self.amqp_container.sasl_server_mechanisms['PLAIN'] = function () {
            return {
                outcome: undefined,
                start: function (response, hostname) {
                    ...
                    var self = this;
                    function authenticate(unused, token) {
                    ...
                    return Promise.resolve(authenticate(fields[1], fields[2], hostname))
...
ConsoleServer.prototype.subscribe = function (name, sender) {
    ...
    this.connections.for_each(function (conn) {
        ...
        log.info("KWDEBUG Sending : %j ", conn);
