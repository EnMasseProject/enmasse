...
function same_addressplan_definition(a, b) {
    if (a === b) return true;
    return a && b && a.addressType === b.addressType && same_addressplan_resources(a.resources, b.resources) && myutils.same_ttl(a.ttl, b.ttl);
}
...
function same_addressplan_status(a, b) {
    if (a === b) return true;
    return a && b && a.isReady === b.isReady && a.phase === b.phase && myutils.same_status_messages(a.messages, b.messages) && myutils.same_ttl(a.ttl, b.ttl);
}
