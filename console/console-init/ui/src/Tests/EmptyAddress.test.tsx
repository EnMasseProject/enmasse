...
describe('Empty Page with Empty state for Addresses', () => {
    test('it renders empty address state instead of list of addresses', () => {
        ...
        const descriptionNode = getByText("There are currently no addresses available. Please click on the button below to create one.Learn more about this on the");
