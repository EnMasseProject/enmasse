...
describe('load brokered and standard plans', () => {
  ...
  it('loadStandardAddressPlans should return plan names', (done) => {
    ...
    mock.onGet('apis/enmasse.io/v1beta1/namespaces/enmasse-infra/addressspaceschemas/standard').reply(200, testStandardPlans);
  ...
  it('loadBrokeredAddressPlans should return plan names', (done) => {
    ...
    mock.onGet('apis/enmasse.io/v1beta1/namespaces/enmasse-infra/addressspaceschemas/brokered').reply(200, testBrokeredPlans);
