...
export const AddressDetailHeader: React.FunctionComponent<IAddressDetailHeaderProps> = ({
  ...
  const KebabOptionsLayout = () => {
    const dropdownItems = [
      <DropdownItem
        id="addr-header-edit-item-dropdownitem"
        key="download"
        aria-label="download"
        onClick={() => onEdit(name)}
      >
      ...
      <DropdownItem
        id="addr-header-delete-item-dropdownitem"
        key="delete"
        aria-label="delete"
    ...
    if (
      ...
      dropdownItems.push(
        <DropdownItem
          id="addr-header-purge-item-dropdownitem"
          key="purge"
          aria-label="purge"
    ...
    return (
      <DropdownWithKebabToggle
        ...
        toggleId="addr-header-kebab-dropdowntoggle"
