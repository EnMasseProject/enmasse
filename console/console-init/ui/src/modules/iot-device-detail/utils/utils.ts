...
enum DeviceActionType {
  ...
  CHANGE_CONNECTION_TYPE_VIA_GATEWAYS = "CHANGE_CONNECTION_TYPE_VIA_GATEWAYS",
  CHANGE_CONNECTION_TYPE_CONNECTED_DIRECTLY = "CHANGE_CONNECTION_TYPE_CONNECTED_DIRECTLY",
  EDIT_GATEWAY_GROUP_MEMBERSHIP = "EDIT_GATEWAY_GROUP_MEMBERSHIP"
}
