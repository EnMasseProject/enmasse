import { Button, Dropdown, DropdownToggle, GridItem, Pagination, KebabToggle, DropdownPosition, ButtonVariant, TextInput, PageSection, InputGroup, Grid } from '@patternfly/react-core';
                    ...
                    <GridItem span={6}>
                        <InputGroup>
                            <Dropdown
                                ...
                                dropdownItems={[]}
                            />
                            <TextInput name="search name" id="searchName" type="search" placeholder="Filter by name" aria-label="search input name" />
