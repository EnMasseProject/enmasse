...
public abstract class ControllerBase extends AbstractVerticle implements Watcher<AddressSpace> {
    private static final Logger log = LoggerFactory.getLogger(ControllerBase.class.getName());

    private Watch watch;
    protected final AddressSpaceApi addressSpaceApi;
    protected final OpenShiftClient client;

    protected ControllerBase(AddressSpaceApi addressSpaceApi, OpenShiftClient client) {
    ...
    protected void updateEndpoints(AddressSpace.Builder builder) throws IOException {
    ...
    protected void updateReadiness(ControllerHelper helper, AddressSpace.Builder mutableAddressSpace) {
