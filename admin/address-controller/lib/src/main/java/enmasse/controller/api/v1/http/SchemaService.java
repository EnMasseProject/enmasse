...
import io.enmasse.address.model.impl.k8s.v1.schema.SchemaCodec;
import io.enmasse.address.model.impl.types.standard.StandardAddressSpaceType;
...
public class SchemaService {
    private static final Logger log = LoggerFactory.getLogger(SchemaService.class.getName());
