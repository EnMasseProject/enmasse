...
public class SerializationTest {
    private AddressCodec codec = new AddressCodec();
    ...
    public void testSerializeAddress() throws IOException {
        ...
        io.enmasse.address.model.impl.Address address = new io.enmasse.address.model.impl.Address.Builder()
                .setName("addr1")
                .setAddress("addr1")
    ...
    public void testSerializeAddressList() throws IOException {
        io.enmasse.address.model.impl.Address addr1 = new io.enmasse.address.model.impl.Address.Builder()
                .setName("addr1")
                .setAddress("addr1")
                .setType(StandardType.QUEUE)
                .setPlan(StandardType.QUEUE.getPlans().get(0))
        ...
        io.enmasse.address.model.impl.Address addr2 = new io.enmasse.address.model.impl.Address.Builder()
                .setName("addr2")
                .setAddress("addr2")
    ...
    public void testSerializeInstance() throws IOException {
        Instance instance = new Instance.Builder(AddressSpaceId.withIdAndNamespace("myid", "mynamespace"))
        ...
        assertThat(deserialized.id(), CoreMatchers.is(instance.id()));
        assertThat(deserialized.messagingHost(), CoreMatchers.is(instance.messagingHost()));
        assertThat(deserialized.mqttHost(), CoreMatchers.is(instance.mqttHost()));
        assertThat(deserialized.consoleHost(), CoreMatchers.is(instance.consoleHost()));
    }
