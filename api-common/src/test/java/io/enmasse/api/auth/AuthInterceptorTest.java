...
public class AuthInterceptorTest {
    ...
    public void setUp() throws IOException {
        ...
        when(mockUriInfo.getAbsolutePath()).thenReturn(URI.create("https://localhost:443/apis/address.enmasse.io/v1alpha1/addressspaces"));
        when(mockUriInfo.getPath()).thenReturn("/apis/address.enmasse.io/v1alpha1/addressspaces");
