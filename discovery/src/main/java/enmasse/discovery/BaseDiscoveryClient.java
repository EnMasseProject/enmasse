...
public class BaseDiscoveryClient extends AbstractVerticle {
    private final Map<Symbol, String> labelFilter;
    private final List<DiscoveryListener> listeners = new ArrayList<>();
    private final Logger log = LoggerFactory.getLogger(BaseDiscoveryClient.class.getName());
    private final Endpoint endpoint;
    private final Optional<String> containerName;
    private final String address;
    private Set<Host> currentHosts = new LinkedHashSet<>();

    public BaseDiscoveryClient(Endpoint endpoint, String address, Map<String, String> labelFilter, Optional<String> containerName) {
    ...
    public BaseDiscoveryClient(String address, Map<String, String> labelFilter, Optional<String> containerName) {
