...
var backlog = function (link_stats) {
    var backlog = 0
...
var routerName = function (link_stats, router) {
  return router && router.address ? router.address.split('/')[3] + ":" + link_stats.identity : link_stats.identity
}
