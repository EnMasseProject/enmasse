...
import io.enmasse.iot.registry.infinispan.device.DevicesCredentialsCacheService;
...
/**
 * A device backend that keeps all data in an Infinispan server. This is done by leveraging and unifying
 * {@link DevicesCredentialsCacheService}.
 */
@Repository
...
public class CacheBasedDeviceBackend implements DeviceBackend {
    ...
    private final DevicesCredentialsCacheService registrationService;
    ...
    public CacheBasedDeviceBackend(
            @Qualifier("serviceImpl") final DevicesCredentialsCacheService registrationService) {
    ...
    public void get(final String tenantId, final String type, final String authId, final JsonObject clientContext,
            final Span span,
            final Handler<AsyncResult<CredentialsResult<JsonObject>>> resultHandler) {
        registrationService.get(tenantId, type, authId, clientContext, span, resultHandler);
    }
    ...
    public void set(final String tenantId, final String deviceId, final Optional<String> resourceVersion,
        ...
        registrationService.set(tenantId, deviceId, resourceVersion, credentials, span, resultHandler);
    }
    ...
    public void get(final String tenantId, final String deviceId, final Span span,
        ...
        registrationService.get(tenantId, deviceId, span, f);
        f.compose(r -> {
