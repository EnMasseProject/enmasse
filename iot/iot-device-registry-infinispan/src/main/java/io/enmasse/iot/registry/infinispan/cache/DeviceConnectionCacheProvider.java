...
public class DeviceConnectionCacheProvider extends AbstractCacheProvider {
    ...
    public org.infinispan.configuration.cache.Configuration buildDeviceStateConfiguration() {
    ...
    public RemoteCache<DeviceConnectionKey, String> getDeviceStateCache() {
        return getOrCreateCache("deviceState", buildDeviceStateConfiguration());
    }
