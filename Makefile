...
DOCKER_DIRS	   = topic-forwarder artemis address-controller standard-controller queue-scheduler configserv keycloak-plugin keycloak-controller router router-metrics mqtt-gateway mqtt-lwt
FULL_BUILD 	   = true
