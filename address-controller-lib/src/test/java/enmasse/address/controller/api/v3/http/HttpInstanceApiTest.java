...
import enmasse.address.controller.api.TestInstanceManager;
...
public class HttpInstanceApiTest {
    ...
    public void testGet() {
        ...
        assertThat(response.getStatus(), is(200));
        Instance data = ((enmasse.address.controller.api.v3.Instance)response.getEntity()).getInstance();
    ...
    public void testCreate() {
        Response response = instanceService.createInstance(new enmasse.address.controller.api.v3.Instance(instance1));
        assertThat(response.getStatus(), is(200));
    ...
    public void testDelete() {
        ...
        Response response = instanceService.deleteInstance("instance1", new enmasse.address.controller.api.v3.Instance(instance1));
        assertThat(response.getStatus(), is(200));
