...
function pre_configuration() {
    ...
    echo "export BROKER_TREAT_REJECT_AS_UNMODIFIED_DELIVERY_FAILED=\"${BROKER_TREAT_REJECT_AS_UNMODIFIED_DELIVERY_FAILED}\"" >> $BROKER_CUSTOM/bin/env.sh
    echo "export BROKER_USE_MODIFIED_FOR_TRANSIENT_DELIVERY_ERRORS=\"${BROKER_USE_MODIFIED_FOR_TRANSIENT_DELIVERY_ERRORS}\"" >> $BROKER_CUSTOM/bin/env.sh
    echo "export BROKER_MIN_LARGE_MESSAGE_SIZE=\"${BROKER_MIN_LARGE_MESSAGE_SIZE}\"" >> $BROKER_CUSTOM/bin/env.sh
