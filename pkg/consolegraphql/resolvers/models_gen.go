...
type AddressSpaceConsoleapiEnmasseIoV1beta1 struct {
	...
	Metrics     []*MetricConsoleapiEnmasseIoV1beta1              `json:"Metrics"`
}
...
type LinkSpecConsoleapiEnmasseIoV1beta1 struct {
	Connection *ConnectionConsoleapiEnmasseIoV1beta1 `json:"Connection"`
...
type LinkConsoleapiEnmasseIoV1beta1 struct {
	ObjectMeta *v1.ObjectMeta                      `json:"ObjectMeta"`
	Spec       *LinkSpecConsoleapiEnmasseIoV1beta1 `json:"Spec"`
	Metrics    []*MetricConsoleapiEnmasseIoV1beta1 `json:"Metrics"`
}

type MetricConsoleapiEnmasseIoV1beta1 struct {
