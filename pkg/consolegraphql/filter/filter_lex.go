...
{ tok = TRUE; {( lex.p)++;  lex.cs = 22; goto _out }}
	goto st22
tr26:
//line filter_lex.rl:86
 lex.te = ( lex.p)+1

	goto st22
tr28:
//line filter_lex.rl:83
 lex.te = ( lex.p)+1
