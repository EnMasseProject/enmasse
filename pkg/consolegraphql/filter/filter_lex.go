...
const filterlexer_start int = 21
const filterlexer_first_final int = 21
const filterlexer_error int = 0

const filterlexer_en_main int = 21
...
//line filter_lex.rl:70
 lex.te = ( lex.p)+1
{ tok = NE; {( lex.p)++;  lex.cs = 21; goto _out }}
	goto st21
tr3:
//line filter_lex.rl:56
 lex.te = ( lex.p)+1
{ tok = STRING; out.stringValue = StringVal(lex.data[lex.ts+1:lex.te-1]); {( lex.p)++;  lex.cs = 21; goto _out } }
	goto st21
tr4:
//line filter_lex.rl:48
( lex.p) = ( lex.te) - 1
{ val, _ := strconv.Atoi(string(lex.data[lex.ts:lex.te]));
            out.integralValue = IntVal(val)
            tok = INTEGRAL;
            {( lex.p)++;  lex.cs = 21; goto _out }}
	goto st21
tr7:
//line filter_lex.rl:57
 lex.te = ( lex.p)+1
{ tok = AND; {( lex.p)++;  lex.cs = 21; goto _out }}
	goto st21
tr11:
//line filter_lex.rl:62
 lex.te = ( lex.p)+1
{ tok = FALSE; {( lex.p)++;  lex.cs = 21; goto _out }}
	goto st21
tr14:
//line filter_lex.rl:60
 lex.te = ( lex.p)+1
{ tok = LIKE; {( lex.p)++;  lex.cs = 21; goto _out }}
	goto st21
tr17:
//line filter_lex.rl:59
 lex.te = ( lex.p)+1
{ tok = NOT; {( lex.p)++;  lex.cs = 21; goto _out }}
	goto st21
tr19:
//line filter_lex.rl:63
 lex.te = ( lex.p)+1
{ tok = NULL; {( lex.p)++;  lex.cs = 21; goto _out }}
	goto st21
tr20:
//line filter_lex.rl:58
 lex.te = ( lex.p)+1
{ tok = OR; {( lex.p)++;  lex.cs = 21; goto _out }}
	goto st21
tr23:
//line filter_lex.rl:61
 lex.te = ( lex.p)+1
{ tok = TRUE; {( lex.p)++;  lex.cs = 21; goto _out }}
	goto st21
tr24:
//line filter_lex.rl:75
 lex.te = ( lex.p)+1

	goto st21
tr26:
//line filter_lex.rl:72
 lex.te = ( lex.p)+1
{ tok = '('; {( lex.p)++;  lex.cs = 21; goto _out }}
	goto st21
tr27:
...
//line filter_lex.rl:69
 lex.te = ( lex.p)+1
{ tok = LE; {( lex.p)++;  lex.cs = 21; goto _out }}
	goto st21
tr43:
...
//line filter_lex.rl:68
 lex.te = ( lex.p)+1
{ tok = GE; {( lex.p)++;  lex.cs = 21; goto _out }}
	goto st21
	st21:
//line NONE:1
 lex.ts = 0
