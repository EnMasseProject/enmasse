...
func (kw *AddressSpaceWatcher) Init(c cache.Cache, cl interface{}) error {
...
func (kw *AddressSpaceWatcher) Watch(namespace string) error {
	go func() {
		...
		resource := kw.ClientInterface.AddressSpaces(namespace)
...
func (kw *AddressSpaceWatcher) NewClientForConfig(config *rest.Config) (interface{}, error) {
...
func (kw *AddressSpaceWatcher) doWatch(resource cp.AddressSpaceInterface) error {
	...
	curr, err := kw.Cache.GetMap("AddressSpace/")
