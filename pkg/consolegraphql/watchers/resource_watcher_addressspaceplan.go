...
func (kw *AddressSpacePlanWatcher) Watch(namespace string) error {
	go func() {
		...
		resource := kw.ClientInterface.AddressSpacePlans(namespace)
...
func (kw *AddressSpacePlanWatcher) doWatch(resource cp.AddressSpacePlanInterface) error {
	...
	curr, err := kw.Cache.GetMap("AddressSpacePlan/")
