...
func overrideImageMapFromEnv(data map[string]string) {
	...
	setIfEnvPresent(data, "iot-device-registry-file", "RELATED_IMAGE_IOT_DEVICE_REGISTRY_FILE")
	...
	setIfEnvPresent(data, "iot-tenant-cleaner", "RELATED_IMAGE_IOT_TENANT_CLEANER")
	setIfEnvPresent(data, "iot-tenant-service", "RELATED_IMAGE_IOT_TENANT_SERVICE")
