...
func (r *ReconcileIoTInfrastructure) processAdapterPskCredentials(ctx context.Context, infra *iotv1.IoTInfrastructure, configTracker *configTracker) (reconcile.Result, error) {
	...
	for _, a := range adapters {
		...
		rc.ProcessSimple(func() error {
			return r.processSecret(ctx, name, infra, !a.IsEnabled(infra), func(infra *iotv1.IoTInfrastructure, secret *corev1.Secret) error {
...
func (r *ReconcileIoTInfrastructure) processAuthServicePskSecret(ctx context.Context, infra *iotv1.IoTInfrastructure, authServiceConfigCtx *cchange.ConfigChangeRecorder) error {

	return r.processSecret(ctx, nameAuthServicePskSecret, infra, false, func(infra *iotv1.IoTInfrastructure, secret *corev1.Secret) error {
