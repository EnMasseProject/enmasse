...
type IoTInfrastructure struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`

	Spec   IoTInfrastructureSpec   `json:"spec,omitempty"`
	Status IoTInfrastructureStatus `json:"status,omitempty"`
}

type IoTInfrastructureSpec struct {
...
type IoTInfrastructureStatus struct {
	Phase   InfrastructurePhaseType `json:"phase"`
	Message string                  `json:"message,omitempty"`

	Adapters map[string]AdapterStatus `json:"adapters,omitempty"`
	Services map[string]ServiceStatus `json:"services,omitempty"`

	Conditions []InfrastructureCondition `json:"conditions"`
}

type InfrastructurePhaseType string

const (
	InfrastructurePhaseActive      InfrastructurePhaseType = "Active"
	InfrastructurePhaseConfiguring InfrastructurePhaseType = "Configuring"
	InfrastructurePhaseTerminating InfrastructurePhaseType = "Terminating"
	InfrastructurePhaseFailed      InfrastructurePhaseType = "Failed"
)

type InfrastructureConditionType string

const (
	InfrastructureConditionTypeReady    InfrastructureConditionType = "Ready"
	InfrastructureConditionTypeDegraded InfrastructureConditionType = "Degraded"

	InfrastructureConditionTypeReconciled InfrastructureConditionType = "Reconciled"

	InfrastructureConditionTypeCommandMeshReady                     InfrastructureConditionType = "CommandMeshReady"
	InfrastructureConditionTypeAuthServiceReady                     InfrastructureConditionType = "AuthServiceReady"
	InfrastructureConditionTypeTenantServiceReady                   InfrastructureConditionType = "TenantServiceReady"
	InfrastructureConditionTypeDeviceConnectionServiceReady         InfrastructureConditionType = "DeviceConnectionServiceReady"
	InfrastructureConditionTypeDeviceRegistryAdapterServiceReady    InfrastructureConditionType = "DeviceRegistryAdapterServiceReady"
	InfrastructureConditionTypeDeviceRegistryManagementServiceReady InfrastructureConditionType = "DeviceRegistryManagementServiceReady"

	InfrastructureConditionTypeAmqpAdapterReady    InfrastructureConditionType = "AmqpAdapterReady"
	InfrastructureConditionTypeHttpAdapterReady    InfrastructureConditionType = "HttpAdapterReady"
	InfrastructureConditionTypeLorawanAdapterReady InfrastructureConditionType = "LorawanAdapterReady"
	InfrastructureConditionTypeMqttAdapterReady    InfrastructureConditionType = "MqttAdapterReady"
	InfrastructureConditionTypeSigfoxAdapterReady  InfrastructureConditionType = "SigfoxAdapterReady"
)

type InfrastructureCondition struct {
	Type            InfrastructureConditionType `json:"type"`
...
type IoTInfrastructureList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`

	Items []IoTInfrastructure `json:"items"`
}
