...
func (in *AddressSpaceSchemaSpec) DeepCopyInto(out *AddressSpaceSchemaSpec) {
	*out = *in
	...
	if in.RouteServicePorts != nil {
		in, out := &in.RouteServicePorts, &out.RouteServicePorts
		*out = make([]RouteServicePortDescription, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.CertificateProviderTypes != nil {
		in, out := &in.CertificateProviderTypes, &out.CertificateProviderTypes
		*out = make([]CertificateProviderTypeDescription, len(*in))
		copy(*out, *in)
	}
	if in.EndpointExposeTypes != nil {
		in, out := &in.EndpointExposeTypes, &out.EndpointExposeTypes
		*out = make([]EndpointExposeTypeDescription, len(*in))
		copy(*out, *in)
	}
	return
}
...
func (in *CertificateProviderTypeDescription) DeepCopy() *CertificateProviderTypeDescription {
	...
	out := new(CertificateProviderTypeDescription)
	in.DeepCopyInto(out)
	return out
}
...
func (in *EndpointExposeTypeDescription) DeepCopy() *EndpointExposeTypeDescription {
	...
	out := new(EndpointExposeTypeDescription)
	in.DeepCopyInto(out)
	return out
}
...
func (in *RouteServicePortDescription) DeepCopyInto(out *RouteServicePortDescription) {
	*out = *in
	if in.RouteTlsTerminations != nil {
		in, out := &in.RouteTlsTerminations, &out.RouteTlsTerminations
		*out = make([]RouteTlsTermination, len(*in))
		copy(*out, *in)
	}
	return
}
...
func (in *RouteServicePortDescription) DeepCopy() *RouteServicePortDescription {
	...
	out := new(RouteServicePortDescription)
	in.DeepCopyInto(out)
	return out
}
