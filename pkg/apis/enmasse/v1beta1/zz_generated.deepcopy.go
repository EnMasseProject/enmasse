...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ByNameMatch) DeepCopyInto(out *ByNameMatch) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ByNameMatch.
func (in *ByNameMatch) DeepCopy() *ByNameMatch {
	if in == nil {
		return nil
	}
	out := new(ByNameMatch)
...
func (in *ImageMatch) DeepCopyInto(out *ImageMatch) {
	*out = *in
	if in.ByNameMatch != nil {
		in, out := &in.ByNameMatch, &out.ByNameMatch
		*out = new(ByNameMatch)
		**out = **in
	}
	return
