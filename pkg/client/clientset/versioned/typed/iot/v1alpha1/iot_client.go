...
func (c *IotV1alpha1Client) IoTProjects(namespace string) IoTProjectInterface {
	return newIoTProjects(c, namespace)
}
...
func NewForConfig(c *rest.Config) (*IotV1alpha1Client, error) {
	...
	return &IotV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new IotV1alpha1Client for the given config and
...
func New(c rest.Interface) *IotV1alpha1Client {
	return &IotV1alpha1Client{c}
}
