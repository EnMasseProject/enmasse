...
type MessagingTenantLister interface {
	...
	List(selector labels.Selector) (ret []*v1beta2.MessagingTenant, err error)
...
// List lists all MessagingTenants in the indexer.
func (s *messagingTenantLister) List(selector labels.Selector) (ret []*v1beta2.MessagingTenant, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1beta2.MessagingTenant))
	})
	return ret, err
}
...
type MessagingTenantNamespaceLister interface {
	...
	Get(name string) (*v1beta2.MessagingTenant, error)
...
// List lists all MessagingTenants in the indexer for a given namespace.
func (s messagingTenantNamespaceLister) List(selector labels.Selector) (ret []*v1beta2.MessagingTenant, err error) {
...
// Get retrieves the MessagingTenant from the indexer for a given namespace and name.
func (s messagingTenantNamespaceLister) Get(name string) (*v1beta2.MessagingTenant, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1beta2.Resource("messagingtenant"), name)
	}
	return obj.(*v1beta2.MessagingTenant), nil
}
