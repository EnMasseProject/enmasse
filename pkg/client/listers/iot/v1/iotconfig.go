...
type IoTConfigLister interface {
	...
	List(selector labels.Selector) (ret []*v1.IoTConfig, err error)
...
// List lists all IoTConfigs in the indexer.
func (s *ioTConfigLister) List(selector labels.Selector) (ret []*v1.IoTConfig, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1.IoTConfig))
	})
	return ret, err
}
...
type IoTConfigNamespaceLister interface {
	...
	Get(name string) (*v1.IoTConfig, error)
...
// List lists all IoTConfigs in the indexer for a given namespace.
func (s ioTConfigNamespaceLister) List(selector labels.Selector) (ret []*v1.IoTConfig, err error) {
...
// Get retrieves the IoTConfig from the indexer for a given namespace and name.
func (s ioTConfigNamespaceLister) Get(name string) (*v1.IoTConfig, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1.Resource("iotconfig"), name)
	}
	return obj.(*v1.IoTConfig), nil
}
