	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.EnmasseV1beta1().Addresses(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.EnmasseV1beta1().Addresses(namespace).Watch(options)
			},
		},
		&enmassev1beta1.Address{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *addressInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&enmassev1beta1.Address{}, f.defaultInformer)
}

func (f *addressInformer) Lister() v1beta1.AddressLister {
	return v1beta1.NewAddressLister(f.Informer().GetIndexer())
}
