	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.EnmasseV1beta1().AuthenticationServices(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.EnmasseV1beta1().AuthenticationServices(namespace).Watch(options)
			},
		},
		&enmassev1beta1.AuthenticationService{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *authenticationServiceInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&enmassev1beta1.AuthenticationService{}, f.defaultInformer)
}
