	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.EnmasseV1().IdentityProviders(namespace).List(options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.EnmasseV1().IdentityProviders(namespace).Watch(options)
			},
		},
		&enmassev1.IdentityProvider{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *identityProviderInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&enmassev1.IdentityProvider{}, f.defaultInformer)
}
