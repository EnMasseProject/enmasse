...
There will be non-root queries permitting traversal from addressspace into connections and address, paginated, both their links which will paginate again.
