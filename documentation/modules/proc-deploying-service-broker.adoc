...
[source, subs="+quotes"]
----
sed -i 's/myproject/_<my-namespace>_/' install/components/service-broker/*.yaml
sed -i 's/myproject/_<my-namespace>_/' install/components/cluster-service-broker/*.yaml
----
