...
= Applying infrastructure configuration on {KubePlatform}

You can edit existing configurations or create new ones.

.Prerequisites
* An infrastructure configuration change that you want to apply. For more information, see xref:infrastructure-configuration-messaging[].
