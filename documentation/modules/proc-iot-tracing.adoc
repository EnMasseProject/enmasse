...
* "Jaeger Operator" from OperatorHub is installed into the {ProductName} namespace
* An instance of Jaeger is deployed using the operator in the {ProductName} namespace
* Know of the Jaeger instance was deployed using the "sidecar" or "daemonset" agent
...
----
. Modify the configuration accoring to your Jaeger agent configuration:
