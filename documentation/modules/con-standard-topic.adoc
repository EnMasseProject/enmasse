...
NOTE: Because subscriptions created after messages have been sent to the topic do not currently work properly, you must create the subscription before you create the topic.
