...
of the IoT project resource, for example, `namespace.iottenant`.
...
+
Example: `sigfox-user@namespace.iottenant`
+
...
----
echo "Basic $(echo -n "sigfox-user@namespace.iottenant:password" | base64)"
----
