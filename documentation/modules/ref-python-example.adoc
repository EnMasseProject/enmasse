...
== Known issue with hierarchical topics

A known issue exists where creating a multicast topic in {ProductName} causes the {BrokerName} to instead create it as an anycast topic.
