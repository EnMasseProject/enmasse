...
.Prerequisites
*You must have link:{BookUrlBase}{BaseProductVersion}{BookNameUrl}#installing-services-iot[installed the IoT services] and link:{BookUrlBase}{BaseProductVersion}{BookNameUrl}#iot-creating-project-iot[created an IoT project].
