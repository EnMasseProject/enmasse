...
[source, subs="+quotes"]
----
sed -i 's/myproject/_<my-namespace>_/' install/components/api-service/*.yaml
sed -i 's/myproject/_<my-namespace>_/' install/components/api-server/*RoleBinding*.yaml
----
