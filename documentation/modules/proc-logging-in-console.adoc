...
.Prerequisites
* You must have obtained the host name for the {ProductName} Console. For more information about how to obtain the host name, see the first step in xref:retrieving-address-space-information-messaging-okd[].
