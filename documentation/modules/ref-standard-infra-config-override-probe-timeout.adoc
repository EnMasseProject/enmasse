...
* link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.5/html-single/applications/index#application-health[{KubePlatform} 4.x documentation about liveness and readiness probes (application health)]
endif::[]
