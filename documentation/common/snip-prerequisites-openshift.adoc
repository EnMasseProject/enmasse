...
** For more information about how to install the CLI on OpenShift 4.5, see the link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.5/html/cli_tools/openshift-cli-oc#installing-the-cli[OpenShift Container Platform 4.5 documentation].
