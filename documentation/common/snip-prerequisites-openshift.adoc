...
** For more information about how to install the CLI on OpenShift 4.x, see the link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.6/html/cli_tools/openshift-cli-oc#installing-openshift-cli[OpenShift Container Platform 4.6 documentation].
