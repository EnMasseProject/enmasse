...
ifndef::OperatorSource[]
{ProductName} can be installed by applying the YAML files using the OpenShift Container Platform command-line interface, or by running the link:https://www.ansible.com/[Ansible^] playbook.
endif::OperatorSource[]
