...
ifdef::ProductUpgrading[]
When upgrading from {ProductName} 1.0 or 1.1.x, be sure to upgrade to the next available version before upgrading to {ProductName} 1.2.0.
endif::ProductUpgrading[]
