...
[id='installing-using-ansible_{context}']
...
system. Example inventory files can be found in the `ansible/inventory` folder. For more information about the supported Ansible configuration settings see xref:ref_ansible-config-settings_{enmasse}[Ansible configuration settings].
