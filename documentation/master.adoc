...
include::assemblies/assembly-configuring-address-spaces-addresses-using-cli.adoc[leveloffset=+2]

include::assemblies/assembly-configuring-address-spaces-addresses-using-restapi.adoc[leveloffset=+2]
