...
// address.broadcast.shortDescription:A scalable 'direct' address for sending messages to multiple consumers
// address.broadcast.longDescription:start
...
// address.broadcast.longDescription:stop
